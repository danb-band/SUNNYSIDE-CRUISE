...
export function UserSearchInput({ value, onChange, placeholder = "이름 검색", className }: UserSearchInputProps) {
  ...
  return (
    <div className="relative flex-1">
      <Input
        ...
        className={cn("h-9 bg-white dark:bg-slate-900 border-slate-200 dark:border-slate-700 focus:border-blue-500 focus:ring-blue-500/20 text-sm placeholder:text-slate-400", className)}
      />
